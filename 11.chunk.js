...
/***/ "./src/app/rewards/badges/badges-list.component.ts":
/***/ function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(jQuery) {"use strict";
var core_1 = __webpack_require__("./node_modules/@angular/core/index.js");
var tables_dynamic_data_1 = __webpack_require__("./src/app/rewards/badges/tables-dynamic.data.ts");
var PEOPLE = [
    {
        'id': '1',
        'name': 'Algerd',
...
var BadgesList = (function () {
    ...
    BadgesList.prototype.ngOnInit = function () {
    ...
    BadgesList.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.ng2TableData; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    BadgesList.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
    ...
    BadgesList.prototype.changeFilter = function (data, config) {
        var _this = this;
        if (!config.filtering) {
            return data;
        }
    ...
    BadgesList.prototype.onChangeTable = function (config, page) {
    ...
    BadgesList = __decorate([
        core_1.Component({
            selector: '[badges-list]',
            template: __webpack_require__("./src/app/rewards/badges/badges-list.template.html"),
            encapsulation: core_1.ViewEncapsulation.None,
            styles: [__webpack_require__("./src/app/rewards/badges/badges-list.style.scss")]
        }), 
        __metadata('design:paramtypes', [])
    ], BadgesList);
    return BadgesList;
...
/***/ "./src/app/rewards/badges/badges-list.style.scss":
...
/***/ "./src/app/rewards/badges/badges-list.template.html":
/***/ function(module, exports) {
...
/***/ "./src/app/rewards/badges/tables-dynamic.data.ts":
/***/ function(module, exports) {
...
/***/ "./src/app/rewards/gifts/gifts-list.component.ts":
/***/ function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(jQuery) {"use strict";
var core_1 = __webpack_require__("./node_modules/@angular/core/index.js");
var tables_dynamic_data_1 = __webpack_require__("./src/app/rewards/gifts/tables-dynamic.data.ts");
var PEOPLE = [
    {
        'id': '1',
        'name': 'Algerd',
...
var GiftsList = (function () {
    ...
    GiftsList.prototype.ngOnInit = function () {
        var searchInput = jQuery('#table-search-input, #search-countries');
        searchInput
            .focus(function (e) {
            jQuery(e.target).closest('.input-group').addClass('focus');
    ...
    GiftsList.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.ng2TableData; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    GiftsList.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
        var columns = this.config.sorting.columns || [];
    ...
    GiftsList.prototype.changeFilter = function (data, config) {
        var _this = this;
        if (!config.filtering) {
            return data;
        }
    ...
    GiftsList.prototype.onChangeTable = function (config, page) {
        if (page === void 0) { page = { page: this.page, itemsPerPage: this.itemsPerPage }; }
        if (config.filtering) {
            Object.assign(this.config.filtering, config.filtering);
        }
    ...
    GiftsList = __decorate([
        core_1.Component({
            selector: '[gifts-list]',
            template: __webpack_require__("./src/app/rewards/gifts/gifts-list.template.html"),
            encapsulation: core_1.ViewEncapsulation.None,
            styles: [__webpack_require__("./src/app/rewards/gifts/gifts-list.style.scss")]
        }), 
        __metadata('design:paramtypes', [])
    ], GiftsList);
    return GiftsList;
}());
exports.GiftsList = GiftsList;

/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__("./node_modules/jquery/dist/jquery.js")))

/***/ },

/***/ "./src/app/rewards/gifts/gifts-list.style.scss":
/***/ function(module, exports) {
...
/***/ "./src/app/rewards/gifts/gifts-list.template.html":
/***/ function(module, exports) {
...
/***/ "./src/app/rewards/gifts/tables-dynamic.data.ts":
/***/ function(module, exports) {
...
/***/ "./src/app/rewards/paypalpayouts/paypalpayouts-list.component.ts":
/***/ function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(jQuery) {"use strict";
var core_1 = __webpack_require__("./node_modules/@angular/core/index.js");
var tables_dynamic_data_1 = __webpack_require__("./src/app/rewards/paypalpayouts/tables-dynamic.data.ts");
var PEOPLE = [
    {
        'id': '1',
        'name': 'Algerd',
...
var PaypalpayoutsList = (function () {
    function PaypalpayoutsList() {
        this.data = PEOPLE;
        this.rows = [];
        this.columns = [
            { title: 'Name', name: 'name' },
    ...
    PaypalpayoutsList.prototype.ngOnInit = function () {
        var searchInput = jQuery('#table-search-input, #search-countries');
        searchInput
            .focus(function (e) {
            jQuery(e.target).closest('.input-group').addClass('focus');
    ...
    PaypalpayoutsList.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.ng2TableData; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    PaypalpayoutsList.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
        var columns = this.config.sorting.columns || [];
    ...
    PaypalpayoutsList.prototype.changeFilter = function (data, config) {
        var _this = this;
        if (!config.filtering) {
            return data;
        }
    ...
    PaypalpayoutsList.prototype.onChangeTable = function (config, page) {
        if (page === void 0) { page = { page: this.page, itemsPerPage: this.itemsPerPage }; }
        if (config.filtering) {
            Object.assign(this.config.filtering, config.filtering);
        }
    ...
    PaypalpayoutsList = __decorate([
        core_1.Component({
            selector: '[paypalpayouts-list]',
            template: __webpack_require__("./src/app/rewards/paypalpayouts/paypalpayouts-list.template.html"),
            encapsulation: core_1.ViewEncapsulation.None,
            styles: [__webpack_require__("./src/app/rewards/paypalpayouts/paypalpayouts-list.style.scss")]
        }), 
        __metadata('design:paramtypes', [])
    ], PaypalpayoutsList);
    return PaypalpayoutsList;
}());
exports.PaypalpayoutsList = PaypalpayoutsList;

/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__("./node_modules/jquery/dist/jquery.js")))

/***/ },

/***/ "./src/app/rewards/paypalpayouts/paypalpayouts-list.style.scss":
/***/ function(module, exports) {
...
/***/ "./src/app/rewards/paypalpayouts/paypalpayouts-list.template.html":
/***/ function(module, exports) {

module.exports = "<div class=\"row\">\r\n  <div class='col-lg-6 col-xs-6'>\r\n\r\n<h1 class=\"page-title\">Paypal Payouts</h1>\r\n    </div>\r\n  <div class='col-lg-6 col-xs-6'>\r\n      <a class=\"btn btn-md pull-right logout-btn\" [routerLink]=\" ['/login'] \">Logout</a>\r\n    </div>\r\n</div>\r\n<!--<h1 class=\"page-title\">Admins</h1>-->\r\n<section class=\"widget\" widget>\r\n  <header>\r\n  <!--  <h4>The <span class=\"fw-semi-bold\">Angular</span> Way</h4> -->\r\n    <div class=\"widget-controls\">\r\n      <a data-widgster=\"expand\" title=\"Expand\" href=\"#\"><i class=\"glyphicon glyphicon-chevron-up\"></i></a>\r\n      <a data-widgster=\"collapse\" title=\"Collapse\" href=\"#\"><i class=\"glyphicon glyphicon-chevron-down\"></i></a>\r\n      <a data-widgster=\"close\" title=\"Close\" href=\"#\"><i class=\"glyphicon glyphicon-remove\"></i></a>\r\n    </div>\r\n  </header>\r\n  <div class=\"widget-body\">\r\n  <!--  <p>\r\n      Column sorting, live search, pagination. Built with\r\n      <a href=\"https://github.com/mariuszfoltak/angular2-datatable\" target=\"_blank\">angular2-datatables</a>\r\n    </p> -->\r\n    <div class=\"mt\">\r\n      <div class=\"width-200 pull-xs-right\">\r\n        <div class=\"input-group input-group-sm input-group-transparent input-group-rounded\">\r\n          <span class=\"input-group-addon\">\r\n            <i class=\"fa fa-search\"></i>\r\n          </span>\r\n          <input class=\"form-control form-control-sm\" id=\"table-search-input\" [(ngModel)]=\"searchText\" type=\"text\" placeholder=\"Search Countries\">\r\n        </div>\r\n      </div>\r\n      <table class=\"table table-striped table-hover\" [mfData]=\"data\" #mf=\"mfDataTable\" [mfRowsOnPage]=\"10\">\r\n        <thead>\r\n        <tr>\r\n          <th>\r\n            <mfDefaultSorter by=\"id\">Id</mfDefaultSorter>\r\n          </th>\r\n          <th>\r\n            <mfDefaultSorter by=\"name\">Name</mfDefaultSorter>\r\n          </th>\r\n          <th class=\"no-sort hidden-sm-down\">\r\n            <mfDefaultSorter by=\"info\">Info</mfDefaultSorter>\r\n          </th>\r\n          <th class=\"hidden-sm-down\">\r\n            <mfDefaultSorter by=\"description\">Description</mfDefaultSorter>\r\n          </th>\r\n          <th class=\"hidden-sm-down\">\r\n            <mfDefaultSorter by=\"date\">Date</mfDefaultSorter>\r\n          </th>\r\n          <th class=\"no-sort\">\r\n            <mfDefaultSorter by=\"status\">Status</mfDefaultSorter>\r\n          </th>\r\n        </tr>\r\n        </thead>\r\n        <tbody>\r\n        <tr *ngFor=\"let person of mf.data | SearchPipe : searchText\">\r\n          <td>{{person.id}}</td>\r\n          <td><span class=\"fw-semi-bold\">{{person.name}}</span></td>\r\n          <td class=\"hidden-sm-down\">\r\n            <small>\r\n              <span class=\"fw-semi-bold\">Type:</span>\r\n              &nbsp; {{person.info.type}}\r\n            </small>\r\n            <br>\r\n            <small>\r\n              <span class=\"fw-semi-bold\">Dimensions:</span>\r\n              &nbsp; {{person.info.dimensions}}\r\n            </small>\r\n          </td>\r\n          <td class=\"hidden-sm-down\"><a href=\"#\">{{person.description}}</a></td>\r\n          <td class=\"hidden-sm-down\">{{person.date}}</td>\r\n          <td class=\"width-150\">\r\n            <div class=\"bg-gray-lighter progress-bar mt-xs\">\r\n              <progress class=\"progress progress-sm progress-{{person.status.type}}\" value=\"100\" max=\"100\" [ngStyle]=\"{ 'width': person.status.progress}\"></progress>\r\n            </div>\r\n          </td>\r\n        </tr>\r\n        <tr *ngIf=\"(mf.data | SearchPipe : searchText).length === 0\">\r\n          <td colspan=\"100\">\r\n            No matches\r\n          </td>\r\n        </tr>\r\n        </tbody>\r\n        <tfoot>\r\n        <tr>\r\n          <td colspan=\"12\">\r\n            <mfBootstrapPaginator [rowsOnPageSet]=\"[10, 25, 50, 100]\"></mfBootstrapPaginator>\r\n          </td>\r\n        </tr>\r\n        </tfoot>\r\n      </table>\r\n    </div>\r\n  </div>\r\n</section>\r\n<section class=\"widget\" widget>\r\n  <header>\r\n    <h4>Ng2 <span class=\"fw-semi-bold\">Tables</span></h4>\r\n    <div class=\"widget-controls\">\r\n      <a data-widgster=\"expand\" title=\"Expand\" href=\"#\"><i class=\"glyphicon glyphicon-chevron-up\"></i></a>\r\n      <a data-widgster=\"collapse\" title=\"Collapse\" href=\"#\"><i class=\"glyphicon glyphicon-chevron-down\"></i></a>\r\n      <a data-widgster=\"close\" title=\"Close\" href=\"#\"><i class=\"glyphicon glyphicon-remove\"></i></a>\r\n    </div>\r\n  </header>\r\n  <div class=\"widget-body\">\r\n    <p>\r\n      Simple table extension with sorting, filtering and pagination for Angular2 apps. Built with\r\n      <a href=\"http://valor-software.github.io/ng2-table/\" target=\"_blank\">ng2-table</a>\r\n    </p>\r\n    <p>\r\n      <input *ngIf=\"config.filtering\"\r\n             [ngTableFiltering]=\"config.filtering\"\r\n             (tableChanged)=\"onChangeTable(config)\"\r\n             class=\"form-control input-no-border bg-gray-lighter\"\r\n             placeholder=\"Filter Table\" type=\"text\">\r\n    </p>\r\n    <ng-table [config]=\"config.sorting\"\r\n              (tableChanged)=\"onChangeTable(config)\"\r\n              [rows]=\"rows\" [columns]=\"columns\">\r\n    </ng-table>\r\n    <pagination *ngIf=\"config.paging\"\r\n                class=\"pagination-sm\"\r\n                [(ngModel)]=\"page\"\r\n                [totalItems]=\"length\"\r\n                [itemsPerPage]=\"itemsPerPage\"\r\n                [maxSize]=\"maxSize\"\r\n                [boundaryLinks]=\"true\"\r\n                [rotate]=\"false\"\r\n                (pageChanged)=\"onChangeTable(config, $event)\"\r\n                (numPages)=\"numPages = $event\">\r\n    </pagination>\r\n    <pre *ngIf=\"config.paging\" class=\"card card-block card-header\">Page: {{page}} / {{numPages}}</pre>\r\n  </div>\r\n\r\n</section>\r\n"

/***/ },

/***/ "./src/app/rewards/paypalpayouts/tables-dynamic.data.ts":
/***/ function(module, exports) {
...
/***/ "./src/app/rewards/raffles/pipes/search-pipe.ts":
/***/ function(module, exports, __webpack_require__) {
...
/***/ "./src/app/rewards/raffles/raffles-list.component.ts":
/***/ function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(jQuery) {"use strict";
var core_1 = __webpack_require__("./node_modules/@angular/core/index.js");
var tables_dynamic_data_1 = __webpack_require__("./src/app/rewards/raffles/tables-dynamic.data.ts");
var PEOPLE = [
    {
        'id': '1',
        'name': 'Algerd',
...
var RafflesList = (function () {
    ...
    RafflesList.prototype.ngOnInit = function () {
        var searchInput = jQuery('#table-search-input, #search-countries');
        searchInput
            .focus(function (e) {
            jQuery(e.target).closest('.input-group').addClass('focus');
    ...
    RafflesList.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.ng2TableData; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    RafflesList.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
        var columns = this.config.sorting.columns || [];
    ...
    RafflesList.prototype.changeFilter = function (data, config) {
        var _this = this;
        if (!config.filtering) {
            return data;
        }
    ...
    RafflesList.prototype.onChangeTable = function (config, page) {
        if (page === void 0) { page = { page: this.page, itemsPerPage: this.itemsPerPage }; }
        if (config.filtering) {
            Object.assign(this.config.filtering, config.filtering);
        }
    ...
    RafflesList = __decorate([
        core_1.Component({
            selector: '[raffles-list]',
            template: __webpack_require__("./src/app/rewards/raffles/raffles-list.template.html"),
            encapsulation: core_1.ViewEncapsulation.None,
            styles: [__webpack_require__("./src/app/rewards/raffles/raffles-list.style.scss")]
        }), 
        __metadata('design:paramtypes', [])
    ], RafflesList);
    return RafflesList;
}());
exports.RafflesList = RafflesList;

/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__("./node_modules/jquery/dist/jquery.js")))

/***/ },

/***/ "./src/app/rewards/raffles/raffles-list.style.scss":
/***/ function(module, exports) {
...
/***/ "./src/app/rewards/raffles/raffles-list.template.html":
/***/ function(module, exports) {
...
/***/ "./src/app/rewards/raffles/tables-dynamic.data.ts":
/***/ function(module, exports) {
...
var vouchers_list_component_1 = __webpack_require__("./src/app/rewards/vouchers/vouchers-list.component.ts");
var gifts_list_component_1 = __webpack_require__("./src/app/rewards/gifts/gifts-list.component.ts");
var badges_list_component_1 = __webpack_require__("./src/app/rewards/badges/badges-list.component.ts");
var paypalpayouts_list_component_1 = __webpack_require__("./src/app/rewards/paypalpayouts/paypalpayouts-list.component.ts");
var raffles_list_component_1 = __webpack_require__("./src/app/rewards/raffles/raffles-list.component.ts");
var search_pipe_1 = __webpack_require__("./src/app/rewards/raffles/pipes/search-pipe.ts");
exports.routes = [
    { path: '', redirectTo: 'rewards', pathMatch: 'full' },
    { path: 'vouchers', component: vouchers_list_component_1.VouchersList },
    { path: 'gifts', component: gifts_list_component_1.GiftsList },
    { path: 'badges', component: badges_list_component_1.BadgesList },
    { path: 'paypalpayouts', component: paypalpayouts_list_component_1.PaypalpayoutsList },
    { path: 'raffles', component: raffles_list_component_1.RafflesList },
];
var RewardsModule = (function () {
    function RewardsModule() {
    }
    RewardsModule.routes = exports.routes;
    RewardsModule = __decorate([
        core_1.NgModule({
            declarations: [
                ...
                //TablesBasic,
                vouchers_list_component_1.VouchersList,
                gifts_list_component_1.GiftsList,
                badges_list_component_1.BadgesList,
                paypalpayouts_list_component_1.PaypalpayoutsList,
                raffles_list_component_1.RafflesList,
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = RewardsModule;


/***/ },

/***/ "./src/app/rewards/vouchers/tables-dynamic.data.ts":
/***/ function(module, exports) {
...
/***/ "./src/app/rewards/vouchers/vouchers-list.component.ts":
/***/ function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(jQuery) {"use strict";
var core_1 = __webpack_require__("./node_modules/@angular/core/index.js");
var tables_dynamic_data_1 = __webpack_require__("./src/app/rewards/vouchers/tables-dynamic.data.ts");
var PEOPLE = [
    {
        'id': '1',
        'name': 'Algerd',
...
var VouchersList = (function () {
    ...
    VouchersList.prototype.ngOnInit = function () {
        var searchInput = jQuery('#table-search-input, #search-countries');
        searchInput
            .focus(function (e) {
            jQuery(e.target).closest('.input-group').addClass('focus');
    ...
    VouchersList.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.ng2TableData; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    VouchersList.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
        var columns = this.config.sorting.columns || [];
    ...
    VouchersList.prototype.changeFilter = function (data, config) {
        var _this = this;
        if (!config.filtering) {
            return data;
        }
    ...
    VouchersList.prototype.onChangeTable = function (config, page) {
        if (page === void 0) { page = { page: this.page, itemsPerPage: this.itemsPerPage }; }
        if (config.filtering) {
            Object.assign(this.config.filtering, config.filtering);
        }
    ...
    VouchersList = __decorate([
        core_1.Component({
            selector: '[vouchers-list]',
            template: __webpack_require__("./src/app/rewards/vouchers/vouchers-list.template.html"),
            encapsulation: core_1.ViewEncapsulation.None,
            styles: [__webpack_require__("./src/app/rewards/vouchers/vouchers-list.style.scss")]
        }), 
        __metadata('design:paramtypes', [])
    ], VouchersList);
    return VouchersList;
}());
exports.VouchersList = VouchersList;

/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__("./node_modules/jquery/dist/jquery.js")))

/***/ },

/***/ "./src/app/rewards/vouchers/vouchers-list.style.scss":
/***/ function(module, exports) {
...
/***/ "./src/app/rewards/vouchers/vouchers-list.template.html":
/***/ function(module, exports) {
