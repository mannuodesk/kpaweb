...
var AgencySuperAdminSignup = (function () {
    ...
    AgencySuperAdminSignup.prototype.SignUpNewAgencySuperAdmin = function () {
        ...
        this.signupService.addAgency(this.AgencyDisplayName, this.AgencySuperAdminName, this.AgencySuperAdminUsername, this.userToBeCreatedRole, this.createdByUserId, sessionStorage.getItem('token')).subscribe(function (a) {
            if (a.code == 200) {
