...
var AgencyAdvancedAdminSignup = (function () {
    ...
    AgencyAdvancedAdminSignup.prototype.SignUpNewAgencyAdvancedAdmin = function () {
        ...
        this.signupService.addUser(this.AgencyAdvancedAdminName, this.AgencyAdvancedAdminUsername, this.userToBeCreatedRole, this.createdByUserId, this.token).subscribe(function (a) {
            if (a.code == 200) {
                _this.userId = a.data;
    ...
    ], AgencyAdvancedAdminSignup.prototype, "userId", void 0);
    __decorate([
        WebStorage_1.SessionStorage(), 
        __metadata('design:type', String)
    ], AgencyAdvancedAdminSignup.prototype, "token", void 0);
