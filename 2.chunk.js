...
/***/ "./src/app/agencysuperadmin/agency-super-admin-signup.component.ts":
/***/ function(module, exports, __webpack_require__) {
...
var AgencySuperAdminSignup = (function () {
    //createdByUserId: string;
    //userToBeCratedRole:number;
    function AgencySuperAdminSignup(signupService, http) {
        this.signupService = signupService;
        this.http = http;
        jQuery(document).ready(function ($) {
            $('.signUp').attr('disabled', true);
            $('#AgencySuperAdmin .field').keyup(function () {
                var empty = false;
                $('.field').each(function () {
                ...
                if (empty) {
                    ...
                    var emailcheck = $("#AgencySuperAdminUsername").val();
                    var re = /^(([^<>()\[\]\.,;:\s@\"]+(\.[^<>()\[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i;
    ...
    AgencySuperAdminSignup.prototype.SignUpNewAgencySuperAdmin = function () {
        var _this = this;
        this.userToBeCreatedRole = "4";
        this.createdByUserId = this.userId;
        this.signupService.addAgency(this.AgencyDisplayName, this.AgencySuperAdminName, this.AgencySuperAdminUsername, this.userToBeCreatedRole, this.createdByUserId, this.token).subscribe(function (a) {
            if (a.code == 200) {
                _this.userId = a.data;
    ...
    ], AgencySuperAdminSignup.prototype, "userId", void 0);
    __decorate([
        WebStorage_1.SessionStorage(), 
        __metadata('design:type', String)
    ], AgencySuperAdminSignup.prototype, "token", void 0);
    AgencySuperAdminSignup = __decorate([
        core_1.Component({
            selector: 'agency-super-admin-signup',
            styles: [__webpack_require__("./src/app/agencysuperadmin/agency-super-admin-signup.style.scss")],
            template: __webpack_require__("./src/app/agencysuperadmin/agency-super-admin-signup.template.html"),
    ...
    ], AgencySuperAdminSignup);
    return AgencySuperAdminSignup;
    var _a, _b;
}());
exports.AgencySuperAdminSignup = AgencySuperAdminSignup;

/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__("./node_modules/jquery/dist/jquery.js")))

/***/ },

/***/ "./src/app/agencysuperadmin/agency-super-admin-signup.module.ts":
/***/ function(module, exports, __webpack_require__) {
...
var agency_super_admin_signup_component_1 = __webpack_require__("./src/app/agencysuperadmin/agency-super-admin-signup.component.ts");
exports.routes = [
    { path: '', component: agency_super_admin_signup_component_1.AgencySuperAdminSignup, pathMatch: 'full' }
];
var AgencySuperAdminSignupModule = (function () {
    function AgencySuperAdminSignupModule() {
    }
    AgencySuperAdminSignupModule.routes = exports.routes;
    AgencySuperAdminSignupModule = __decorate([
        core_1.NgModule({
            declarations: [
                agency_super_admin_signup_component_1.AgencySuperAdminSignup
            ],
            imports: [
    ...
    ], AgencySuperAdminSignupModule);
    return AgencySuperAdminSignupModule;
}());
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = AgencySuperAdminSignupModule;


/***/ },

/***/ "./src/app/agencysuperadmin/agency-super-admin-signup.style.scss":
...
/***/ "./src/app/agencysuperadmin/agency-super-admin-signup.template.html":
/***/ function(module, exports) {

module.exports = "<div class=\"container\">\r\n  <main id=\"content\" class=\"widget-login-container\" role=\"main\">\r\n    <div class=\"row\">\r\n      <div class=\"col-xl-4 col-md-6 col-xs-10 offset-xl-4 offset-md-3 offset-xs-1\">\r\n       <!-- <h5 class=\"widget-login-logo animated fadeInUp\">\r\n          <i class=\"fa fa-circle text-gray\"></i>\r\n          sing\r\n          <i class=\"fa fa-circle text-warning\"></i>\r\n        </h5> -->\r\n        <section class=\"widget widget-login animated fadeInUp\">\r\n          <header style=\"text-align:center\">\r\n            <i class=\"fa fa-user-plus\" aria-hidden=\"true\" style=\"font-size:100px;color:#5ac063\"></i>\r\n          </header>\r\n          <div class=\"widget-body\">\r\n          <!--  <p class=\"widget-login-info\">\r\n              Kuwait Philanthropy Application.\r\n            </p> -->\r\n            <p class=\"widget-login-info\">\r\n             Agency Super Admin Setup\r\n            </p>\r\n            <p class='important-text'>Name and Agency Name should be at least 8 alphabets long</p>\r\n            <form class=\"login-form mt-lg\" id=\"AgencySuperAdmin\">\r\n              <div class=\"form-group\">\r\n                <input type=\"text\" name='AgencyDisplayName'  class=\"form-control field\" id=\"AgencyDisplayName\" [(ngModel)]=\"AgencyDisplayName\" placeholder=\"Agency Name\" required autocomplete=\"off\">\r\n              </div>\r\n\r\n              <div class=\"form-group\">\r\n                <input type=\"text\" name='AgencySuperAdminName'  class=\"form-control field\" id=\"AgencySuperAdminName\" [(ngModel)]=\"AgencySuperAdminName\" placeholder=\"Name\" required autocomplete=\"off\">\r\n              </div>\r\n              <div class=\"form-group\">\r\n                <input class=\"form-control field\" name='AgencySuperAdminUsername' id=\"AgencySuperAdminUsername\" type=\"email\" [(ngModel)]=\"AgencySuperAdminUsername\" placeholder=\"Email\" required autocomplete=\"off\">\r\n              </div>\r\n              <div id=\"successBox\" style=\"display:none\" class=\"alert alert-success alert-sm\">\r\n                \r\n              </div>\r\n              <div id=\"errorBox\" style=\"display:none\" class=\"alert alert-danger alert-sm\">\r\n                \r\n              </div>\r\n              <div class=\"clearfix\">\r\n                <div class=\"btn-toolbar pull-xs-right m-t-1\">\r\n                 <a class=\"mr-n-lg\" [routerLink]=\"['/app', 'dashboard']\">Go Back</a>\r\n                 <!-- <button type=\"button\" class=\"btn btn-secondary btn-sm\">Create an Account</button>-->\r\n                  <a><button class=\"btn btn-sm sign-in-btn signUp\" (click)=\"SignUpNewAgencySuperAdmin()\" value=\"Sign Up\">Send Invite</button></a>\r\n                </div>\r\n              </div>\r\n              <div class=\"row m-t-1\">\r\n                <div class=\"col-md-6 push-md-6\">\r\n                  <div class=\"clearfix\">\r\n                   <!-- <div class=\"abc-checkbox widget-login-info pull-xs-right\">\r\n                      <input type=\"checkbox\" id=\"checkbox1\" value=\"1\">\r\n                      <label for=\"checkbox1\">Keep me signed in </label>\r\n                    </div> -->\r\n                  </div>\r\n                </div>\r\n\r\n               <!-- <div class=\"col-md-6 pull-md-6\">\r\n                  <a class=\"mr-n-lg\" href=\"#\">Forgot Password</a>\r\n                </div> -->\r\n              </div>\r\n            </form>\r\n          </div>\r\n        </section>\r\n      </div>\r\n    </div>\r\n  </main>\r\n  <footer class=\"page-footer\">\r\n  <!--  2016 &copy; Sing. Admin Dashboard Template.-->\r\n  </footer>\r\n</div>\r\n"
