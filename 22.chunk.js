...
var TeamService = (function () {
    ...
    TeamService.prototype.getUsers2 = function () {
        return this.http.get("https://aprilappserver.azurewebsites.net/" + 'users/getAllUsers')
            .map(function (res) { return res.json(); });
    };
    TeamService.prototype.createNewTeam = function (teamName, agencyName, teamDisplayPicture, teamMemebers, teamDescription, token) {
        var formData = new FormData();
        formData.append("teamDisplayPicture", teamDisplayPicture, teamDisplayPicture.name);
        formData.append("agencyName", agencyName);
        formData.append("teamName", teamName);
        formData.append("teamMemebers", teamMemebers);
        formData.append("teamDescription", teamDescription);
        formData.append("token", token);
        var options = new http_1.RequestOptions({ method: 'post' });
        return this.http.post(this.serviceUrl.baseUrl + "TeamRoute/newTeam", formData, options)
            .map(function (res) { return res.json(); });
    };
    TeamService.prototype.getAllUsers = function (token) {
        var headers = new http_1.Headers({ 'x-access-token': token });
        return this.http.get(this.serviceUrl.baseUrl + "TeamRoute/getAllUsers", {
            headers: headers
        }).map(function (res) { return res.json(); });
    };
...
/***/ "./src/app/teams/pipes/search-pipe.ts":
/***/ function(module, exports, __webpack_require__) {
...
/***/ "./src/app/teams/tables-dynamic.data.ts":
...
/***/ "./src/app/teams/teams-list.component.ts":
/***/ function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(jQuery) {"use strict";
var core_1 = __webpack_require__("./node_modules/@angular/core/index.js");
var tables_dynamic_data_1 = __webpack_require__("./src/app/teams/tables-dynamic.data.ts");
var TeamService_1 = __webpack_require__("./src/app/services/TeamService.ts");
var TeamsList = (function () {
    ...
    function TeamsList(teamService) {
        ...
        /*this.teamService.getAllUsers(this.userObject.agencyName, sessionStorage.getItem('token')).subscribe(
          a => {
            this.userTeamList = a.data;
            this.data = this.userTeamList;
            console.log(this.data);
          }
        );*/
    }
    //Get Selected Image Function
    TeamsList.prototype.getTeamImage = function (event) {
        this.file = event.target.files[0];
    };
    //
    TeamsList.prototype.ngOnInit = function () {
    ...
    TeamsList.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.ng2TableData; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    TeamsList.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
    ...
    TeamsList.prototype.changeFilter = function (data, config) {
        var _this = this;
        if (!config.filtering) {
            return data;
        }
    ...
    TeamsList.prototype.onChangeTable = function (config, page) {
    ...
    TeamsList = __decorate([
        core_1.Component({
            selector: '[teams-list]',
            template: __webpack_require__("./src/app/teams/teams-list.template.html"),
            encapsulation: core_1.ViewEncapsulation.None,
            styles: [__webpack_require__("./src/app/teams/teams-list.style.scss")],
            providers: [TeamService_1.TeamService],
        }), 
        __metadata('design:paramtypes', [(typeof (_a = typeof TeamService_1.TeamService !== 'undefined' && TeamService_1.TeamService) === 'function' && _a) || Object])
    ], TeamsList);
    return TeamsList;
    var _a;
}());
...
/***/ "./src/app/teams/teams-list.module.ts":
/***/ function(module, exports, __webpack_require__) {
...
var teams_list_component_1 = __webpack_require__("./src/app/teams/teams-list.component.ts");
var search_pipe_1 = __webpack_require__("./src/app/teams/pipes/search-pipe.ts");
exports.routes = [
    { path: '', component: teams_list_component_1.TeamsList, pathMatch: 'full' }
];
var TeamsListModule = (function () {
    function TeamsListModule() {
    }
    TeamsListModule.routes = exports.routes;
    TeamsListModule = __decorate([
        core_1.NgModule({
            declarations: [
                // Components / Directives/ Pipes
                datatable_1.DataTableDirectives,
                //TablesBasic,
                teams_list_component_1.TeamsList,
